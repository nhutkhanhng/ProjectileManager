...
public class Interpolate
{
     ...
     * elapsed.
     */
    public static IEnumerator<Vector3> NewEase(Function ease, Vector3 start, Vector3 end, float duration)
    {
     ...
     */
    public static IEnumerator<Vector3> NewEase(Function ease, Vector3 start, Vector3 end, int slices)
    {
     ...
     */
    static IEnumerator<Vector3> NewEase(Function ease, Vector3 start, Vector3 end, float total, IEnumerable<float> driver)
    {
